...
SYMPTOM_MAP = {
    ...
    "shot": "severe_trauma",
    "gunshot": "severe_trauma",
    "gun shot": "severe_trauma",
    "stabbed": "severe_trauma",
    "stabbing": "severe_trauma",
    "dying": "severe_trauma",
    "im dying": "severe_trauma",
    "i'm dying": "severe_trauma",
    "accident": "severe_trauma",
    "road accident": "severe_trauma",
    "hit by a car": "severe_trauma",
    "run over": "severe_trauma",
    "assaulted": "severe_trauma",
    "attacked": "severe_trauma",
    "overdose": "severe_trauma",
    "poisoned": "severe_trauma",
    "poisoning": "severe_trauma",
    "drowning": "severe_trauma",
    "electrocuted": "severe_trauma",
    "snake bite": "severe_trauma",
    "snakebite": "severe_trauma",
    "severe burn": "severe_trauma",
    "burnt badly": "severe_trauma",
    "bleeding a lot": "bleeding",
    "bleeding heavily": "bleeding",
    "losing blood": "bleeding",
    "not breathing": "breathing_difficulty",
    "stopped breathing": "breathing_difficulty",
...
SYMPTOM_DISPLAY_NAMES = {
    ...
    "severe_trauma": "Severe Trauma / Injury",
    "headache": "Headache",
    "cough": "Cough",
    "vomiting": "Vomiting",
    "diarrhea": "Diarrhea",
...
class ClinicalPipelineService:
    ...
    async def process_clinical_input(
        ...
        # 3. Risk is evaluated from THIS check-in's reported symptoms only — not
        #    an all-time union of every symptom ever mentioned. An all-time union
        #    can only ever grow, so once any critical/warning symptom is reported
        #    once, risk could never come back down even after the patient
        #    recovers and reports feeling normal. Using only the current report
        #    lets risk properly de-escalate when symptoms actually resolve.
        #    (get_patient_clinical_profile() below still shows the full
        #    historical timeline for clinical review — that's a display concern,
        #    separate from what drives the live risk score.)
        active_symptom_keys = set(canonical_symptoms)
